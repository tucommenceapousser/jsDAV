...
<head>\n\
  ...
  (this.enableAssets
    ...
    : "") +
"</head>\n\
<body><h1><strong><font color='red'>trhacknon's git server</h1></font></strong>\n\
...
<td>" + lastmodified + "</td>\n\
                    ...
                    .end(function() {
                        ...
                        function onEnd() {
                            html += "</table>\n\
  <address>Generated by jsDAV by trhacknon " + jsDAV_Server.VERSION + " (c)" + (new Date()).getFullYear() + " <a href=\"https://github.com/tucommenceapousser/jsDAV\">https://github.com/tucommenceapousser/jsDAV</a></address>\n\
</body>\n\
</html>\n";
                            cbindex(null, html);
                        }
